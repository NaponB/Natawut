...
<div class="wrapper">
  ...
  <div class="row">
    <article class="col-sm-12 col-md-12 col-lg-12 sortable-grid ui-sortable">
        <div id="wid-id-0">
            <header role="heading">
                <h2>ข้อมูลการสั่งจองรายการอาหาร</h2>
            </header>
            <!-- widget div-->
            <div role="content">
                <!-- widget content -->
                            ...
                            <div id="bootstrap-wizard-1" class="col-sm-12">
                                <div class="form-bootstrapWizard">
                                    <ul class="bootstrapWizard form-wizard">
                                        <li class="active" data-target="#step1">
                                            <a href="#tab1" data-toggle="tab" class="active"> <span class="step">1</span> <span class="title"></span> </a>
                                        </li>
                                        <li data-target="#step2" class="">
                                            <a href="#tab2" data-toggle="tab"> <span class="step">2</span> <span class="title"></span> </a>
                                        </li>
                                        <li data-target="#step3" class="">
                                            <a href="#tab3" data-toggle="tab"> <span class="step">3</span> <span class="title"></span> </a>
                                        </li>
                                        <li data-target="#step4">
                                            <a href="#tab4" data-toggle="tab"> <span class="step">4</span> <span class="title"></span> </a>
                                        </li>
                                    </ul>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="tab3">
                                        ...
                                        <div class="col-md-10">
                                          <div class="well">
                                            <h2 class="text-muted">สรุปรายการสั่งซื้อ</h2>
                                            <p>สาขาที่สั่งจอง</p>
                                            <p> เวลาที่จะไป</p>
                                            <p> โต๊ะที่จอง</p>
