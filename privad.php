...
<body>
  ...
  <div class ="box-box">
    ...
    <div class="box-emp">
      ...
      <div class="box-boxe1">
        <p><?echo $objReSult['cus_fname']." ".$objReSult['cus_lname'];?></p>
      </div>
      <div class="box-boxe">
        <p>ที่อยู่</p>
      </div>
      <div class="box-boxe1">  
       <p><?echo $objReSult['cus_add'];?></p>
      </div>
      <div class="box-boxe">  
        <p>เบอร์โทรศัพท์</p>
      </div>
      <div class="box-boxe1">  
        <p><?echo $objReSult['cus_tel'];?></p>
      </div>
      <div class="box-boxe">   
        <p>E-mail</p>
      </div>
      <div class="box-boxe1">  
        <p><?echo $objReSult['cus_email'];?></p>
      </div>
      <? } ?>
      <div class ="boxe-add1">
        <a href="editprivad.php"><input type="button"  name= "submit" class="button button1" value = "แก้ไข"onclick =""></a>
      </div>
    </div>
        <br><br>
        <div class="box-emp1">
        <br><br>
        <h1>เปลี่ยนรหัสผ่าน</h1><br><br>
        <div class = "h"></div><br>
        <div class="boxe">
