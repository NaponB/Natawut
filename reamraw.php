...
<div class="container-fluid">
  <div class="row content">
   <div class="col-sm-2 sidenav hidden-xs"><br>
      ...
      <div class="col-sm-10">
        <div class="col-md-8">
          <h4><small>ข้อมูลการเบิกจ่ายวัตถุดิบ</small></h4>
        </div>
        <div class="col-md-4">
      ...
      <div class="col-sm-2"></div>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a class="btn btn-primary" href="ream_raw.php" role="button"><img class="plus" src="img/plus.png">&nbsp;เพิ่มการเบิกจ่ายวัตถุดิบ</a>
      <br><br>
      <div class="col-sm-2"></div>
          <div class="col-sm-10">
            <div class="well">
