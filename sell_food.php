...
<div class="container-fluid">
  <div class="row content">
    ...
    <br>
      ...
      <a href="add_ord_food.php"><button type="button" class="btn btn-success"><img class="plus" src="img/plus.png"> &nbsp; สั่งอาหาร</button></a>
      <br><br>
      <div class="col-sm-2"></div>
          <div class="col-sm-10">
            <div class="well">
