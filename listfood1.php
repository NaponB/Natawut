...
?>
  ...
  <div class="box-box-box"> 
    ...
    <div class="box-row">
      ...
      <br>
      <form method="post">
      <p>ค้นหาข้อมูลรายการอาหาร สาขาที่ 1</p>
      <ul>
    ...
    <table>
      ...
      <?
        ...
        if ($strKeyword != "") {
          # code...
           $strSQL = "SELECT  * FROM menu where menu_id = '".$strKeyword."' AND branch = '".$_SESSION['emp_branch']."'";
          $objQuery = mysql_query($strSQL) or die("Error Query [".$strSQL."]");
        }
        else  {
          $strSQL = "SELECT  * FROM menu where branch = '".$_SESSION['emp_branch']."'";
          $objQuery = mysql_query($strSQL) or die("Error Query [".$strSQL."]");    
      ...
      ?>
        ...
        <td><img src ="image2/food/<?echo $objReSult['foodPic'];?>" width = "50px" height = "50px"></td>
        <td>
          <ul>
            <li><a href="editlistf1.php?m_id=<?echo $objReSult['menu_id'];?>"><i class="fa fa-pencil-square-o  tooltip" aria-hidden="true" style="cursor:pointer"><span class="tooltiptext">แก้ไขข้อมูล</span></i></a></li>&nbsp;&nbsp;&nbsp;
            <li><a href="del_listf1.php?m_id=<?echo $objReSult['menu_id'];?>" onclick="return confirm('ยืนยันการลบข้อมูล ??')"><i class="fa fa-trash-o  tooltip" aria-hidden="true" style="cursor:pointer"><span class="tooltiptext">ลบข้อมูล</span></i></a></li>
          </ul>
        </td>
      </tr>
      <?
