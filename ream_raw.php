            ...
            <div class="row">
              ...
              <div class="col-sm-5">
                <div class="well">
                 <?
          @include('conn.php');
          $new_id =mysql_result(mysql_query("Select Max(substr(ream_id,-3))+1 as MaxID from ream_raw"),0,"MaxID");
          if($new_id==''){ // ถ้าได้เป็นค่าว่าง หรือ null ก็แสดงว่ายังไม่มีข้อมูลในฐานข้อมูล
                $ream_id="REA001";
            }else{
                $ream_id="REA".sprintf("%03d",$new_id);//ถ้าไม่ใช่ค่าว่าง
            }
          ?>
                  <label for="">รหัสการเบิกจ่ายวัตถุดิบ</label>
                  <input type="text" class="form-control" id="ream_id" disabled value="<?echo $ream_id;?>">
                  <br>
                  <label for="">พนักงาน</label>
                  <input type="text" class="form-control" id="emp_name" disabled value="test">
                  <br>
                ...
                ?>
                  ...
                  <input type="date" class="form-control" id="ream_date" min="<?php echo date('Y-m-d'); ?>" value="<?php echo date('Y-m-d'); ?>">
                  <br>
...
<script>
  ...
  .done(function( msg ) {
      alert(msg);
     //$('#myModal').modal('hide');
  window.location = "det_ream_raw.php?ream_id="+ream_id;
  });
  // alert("กำลังทำรายการ");
  }
