  ...
  <div class="row content">
   <div class="col-sm-2 sidenav hidden-xs"><br>
    ...
    <br>
      ...
      <div class="col-sm-10">
        <div class="col-md-8">
          <h4><small><a href="reamraw.php">ข้อมูลเบิกจ่ายวัตถุดิบ</a>&nbsp;&nbsp; <img class="next" src="img/next.png"><a href="ream_raw.php">&nbsp;&nbsp;เพิ่มข้อมูลเบิกจ่ายวัตถุดิบ</a>&nbsp;&nbsp; <img class="next" src="img/next.png"> &nbsp;&nbsp;รายการเบิกจ่ายวัตถุดิบ</small></h4>
        </div>
        <div class="col-md-4">
